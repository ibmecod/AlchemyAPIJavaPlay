...
class CategoryTest {
               ...
               ParserConfigurationException, XPathExpressionException
    {
		...
		Document doc = alchemyObj.URLGetCategory(URLString);
		
		String convertDocToString = AlchemyUtility.getStringFromDocument(doc);
		String alchemyAPIResult = AlchemyUtility.returnResultFromXML(convertDocToString,"category");
		System.out.println("Output from URLGetCategory AlchemyAPI: Category is -->  " + alchemyAPIResult);
